...
namespace WebAPI.Models
{
    ...
    public class Cost
    {
        ...
        public static List<Cost> getCosts(String ProjectID, String TrendNumber, String PhaseCode, String ActivityID, String Granularity, String BudgetID, String BudgetCategory, String BudgetSubCategory, String ViewLabor)
        {
            int CostNumber = 0;
            ...
            //-------------------------------------------------------------------------------
                ...
                matchedActivityList = WebAPI.Models.Activity.getActivityDetails("null", "null", ProjectID, TrendNumber, PhaseCode, ActivityID, "null", "null");
