...
{
    public class RequestCustomerReportController : System.Web.Http.ApiController
    {
        readonly log4net.ILog logger = log4net.LogManager.GetLogger(System.Reflection.MethodBase.GetCurrentMethod().DeclaringType);

        public HttpResponseMessage GetReport(String OrganizationID, String ProgramElementID, String ProjectID, String FileType)
        {
            ...
            {
                Byte[] bytes = { };
                bytes = generatePDF(OrganizationID,ProgramElementID, ProjectID, FileType, "CustomerReport");
        ...
        private Byte[] generatePDF(String OrganizationID, String ProgramElementID, String ProjectID, String FileType, String reportName)
        {
            ...
            param3.Name = "OrganizationID";
            param3.Value = OrganizationID;
