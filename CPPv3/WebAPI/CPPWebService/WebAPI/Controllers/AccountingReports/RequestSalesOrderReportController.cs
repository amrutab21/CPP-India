...
{
    public class RequestSalesOrderReportController : System.Web.Http.ApiController
    {
        ...
        public HttpResponseMessage GetReport(String ProgramElementID, String ProjectID, String TrendID, String FileType)
        {
            ...
            {
                Byte[] bytes = { };
                bytes = generatePDF(ProgramElementID, ProjectID, TrendID, FileType, "SalesOrderReport");
