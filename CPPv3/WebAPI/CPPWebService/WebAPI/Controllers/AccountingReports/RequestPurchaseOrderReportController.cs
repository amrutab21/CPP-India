...
{
    public class RequestPurchaseOrderReportController : System.Web.Http.ApiController
    {
        readonly log4net.ILog logger = log4net.LogManager.GetLogger(System.Reflection.MethodBase.GetCurrentMethod().DeclaringType);

        public HttpResponseMessage GetReport(String ProgramElementID, String ProjectID, String TrendID, String FileType)
        {
            ...
            {
                Byte[] bytes = { };
                bytes = generatePDF(ProgramElementID, ProjectID, TrendID, FileType, "PurchaseOrderReport");
        ...
        private Byte[] generatePDF(String ProgramElementID, String ProjectID, String TrendID, String FileType, String reportName)
        {
