...
namespace WebAPI.Controllers.UserReports
{
    public class RequestContractReportController : System.Web.Http.ApiController
    {
        readonly log4net.ILog logger = log4net.LogManager.GetLogger(System.Reflection.MethodBase.GetCurrentMethod().DeclaringType);


    public HttpResponseMessage GetReport(String OrganizationID, String ClientId,String FileType)
    {
        ...
        try
        {
            ...
            Byte[] bytes = { };
            bytes = generatePDF(OrganizationID, ClientId, FileType, "ContractReport");
    ...
    private Byte[] generatePDF(String OrganizationID, String ClientId, String FileType, String reportName)
    {
