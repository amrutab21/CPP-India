...
{
    public class RequestTestingSSRSController : System.Web.Http.ApiController
    {
        readonly log4net.ILog logger = log4net.LogManager.GetLogger(System.Reflection.MethodBase.GetCurrentMethod().DeclaringType);

        public HttpResponseMessage GetReport(String ReportParameter1, String FileType)
        {
            ...
            {
                Byte[] bytes = { };
                bytes = generatePDF(ReportParameter1, FileType, "TestingSSRS");
        ...
        private Byte[] generatePDF(String ReportParameter1, String FileType, String reportName)
        {
            ...
            try
            {
                ...
                //Enable Network Credential if test it locally
                rs.Credentials = new NetworkCredential("Administrator", "Birdi@123");
                //rs.Credentials = System.Net.CredentialCache.DefaultNetworkCredentials; //Enable this for deployment
