...
{
	public class RequestBaselineExportFromCPPIntoJonasReportController : System.Web.Http.ApiController
	{
		readonly log4net.ILog logger = log4net.LogManager.GetLogger(System.Reflection.MethodBase.GetCurrentMethod().DeclaringType);

		public HttpResponseMessage GetReport(String ProgramElementID, String ProjectID, String ReportVersion, String FileType)
		{
			...
			try
			{
				...
				String reportPathName = "BaselineExportFromCPPIntoJonasReport";

				if(ReportVersion == "1") {
					reportPathName = "BaselineExportFromCPPIntoJonasReport";
				}
				else if(ReportVersion == "2")
				{
					reportPathName = "BaselinePairRevenueExportFromCPPIntoJonasReport";
				}
				else if(ReportVersion == "3")
				{
					reportPathName = "BaselineOneTotalRevenueExportFromCPPIntoJonasReport";
				}

				bytes = generatePDF(ProgramElementID, ProjectID, FileType, reportPathName);
		...
		private Byte[] generatePDF(String ProgramElementID, String ProjectID, String FileType, String reportName)
		{
			...
			SsrsReportService.ParameterValue[] reportHistoryParameters = new SsrsReportService.ParameterValue[2];
