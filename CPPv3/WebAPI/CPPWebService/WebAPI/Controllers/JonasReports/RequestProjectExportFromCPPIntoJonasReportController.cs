...
{
	public class RequestProjectExportFromCPPIntoJonasReportController : System.Web.Http.ApiController
	{
		readonly log4net.ILog logger = log4net.LogManager.GetLogger(System.Reflection.MethodBase.GetCurrentMethod().DeclaringType);

		public HttpResponseMessage GetReport(String ProgramElementID, String FileType)
		{
			...
			{
				Byte[] bytes = { };
				bytes = generatePDF(ProgramElementID, FileType, "ProjectExportFromCPPIntoJonasReport");
		...
		private Byte[] generatePDF(String ProgramElementID, String FileType, String reportName)
		{
