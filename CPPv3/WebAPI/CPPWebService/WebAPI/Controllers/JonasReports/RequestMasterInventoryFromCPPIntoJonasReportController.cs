...
{
	public class RequestMasterInventoryExportFromCPPIntoJonasReportController : System.Web.Http.ApiController
	{
		readonly log4net.ILog logger = log4net.LogManager.GetLogger(System.Reflection.MethodBase.GetCurrentMethod().DeclaringType);

		public HttpResponseMessage GetReport(String CostType, String FileType)
		{
			...
			{
				Byte[] bytes = { };
				bytes = generatePDF(CostType, FileType, "MasterInventoryReport");
		...
		private Byte[] generatePDF(String CostType, String FileType, String reportName)
		{
			...
			SsrsReportService.ParameterValue[] reportHistoryParameters = new SsrsReportService.ParameterValue[1];

			SsrsReportService.ParameterValue param1 = new SsrsReportService.ParameterValue();
			param1.Name = "Category_Code";
			param1.Value = "\"" + CostType + "\"";
