...
{
    public class RequestActivitiesForGanttAtProjectLevelController : ApiController
    {
        [HttpGet]
        ...
        public HttpResponseMessage GetActivities(String CostBreakdown = "0", String ProgramID = "null", String ProgramElementID = "null", String ProjectID = "null", String TrendNumber = "null", String PhaseCode = "null", String ActivityID = "null", String BudgetCategory = "null", String BudgetSubCategory = "null")
        {
            ...
            if (CostBreakdown == "0")
            {
                ActivityList = WebAPI.Models.ViewProgramElementGanttActivities.getActivityDetails(ProgramID, ProgramElementID, ProjectID, TrendNumber, PhaseCode, ActivityID, BudgetCategory, BudgetSubCategory);
            }
