...
{
    public class RequestBudgetSummaryReportController : System.Web.Http.ApiController
    {
        readonly log4net.ILog logger = log4net.LogManager.GetLogger(System.Reflection.MethodBase.GetCurrentMethod().DeclaringType);

        public HttpResponseMessage GetReport(String ProjectID, String Granularity, String FileType, String TrendNumber)
        {
            ...
            {
                Byte[] bytes = { };
                bytes = generatePDF(ProjectID, Granularity, FileType, "BudgetSummaryReport", TrendNumber);
        ...
        private Byte[] generatePDF(String ProjectID, String Granularity, String FileType, String reportName, String TrendNumber)
        {
