...
{
    public class RequestPurchaseOrderDetailReportController : System.Web.Http.ApiController
    {
        readonly log4net.ILog logger = log4net.LogManager.GetLogger(System.Reflection.MethodBase.GetCurrentMethod().DeclaringType);

        public HttpResponseMessage GetReport(String PurchaseOrderNumber, String FileType)
        {
            ...
            {
                Byte[] bytes = { };
                bytes = generatePDF(PurchaseOrderNumber, FileType, "PurchaseOrderDetailReport");
        ...
        public Byte[] generatePDF(String PurchaseOrderNumber, String FileType, String reportName)
        {
            ...
            param1.Name = "PurchaseOrderNumber";
            param1.Value = "\"" + PurchaseOrderNumber + "\"";
