...
{
    public class RequestSubcontractorReportController : System.Web.Http.ApiController
    {
        readonly log4net.ILog logger = log4net.LogManager.GetLogger(System.Reflection.MethodBase.GetCurrentMethod().DeclaringType);

        public HttpResponseMessage GetReport(String ProjectID, String FileType,String TrendNumber)
        {
            ...
            {
                Byte[] bytes = { };
                bytes = generatePDF(ProjectID, FileType, TrendNumber, "CPPSubcontractorReport");
        ...
        private Byte[] generatePDF(String ProjectID, String FileType,String TrendNumber, String reportName)
        {
            ...
            param2.Name = "TrendNumber";
            param2.Value = TrendNumber;
