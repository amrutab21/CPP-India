...
{
    public class RequestSummaryReportController : System.Web.Http.ApiController
    {
        readonly log4net.ILog logger = log4net.LogManager.GetLogger(System.Reflection.MethodBase.GetCurrentMethod().DeclaringType);

        public HttpResponseMessage GetReport(String ProjectID, String StartDate, String FileType)
        {
            ...
            {
                Byte[] bytes = { };
                bytes = generatePDF(ProjectID, StartDate, FileType, "SummaryReport");
        ...
        private Byte[] generatePDF(String ProjectID, String StartDate, String FileType, String reportName)
        {
