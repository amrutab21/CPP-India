...
{
	public class RequestBudgetSummaryCPP1ReportController : System.Web.Http.ApiController
	{
		readonly log4net.ILog logger = log4net.LogManager.GetLogger(System.Reflection.MethodBase.GetCurrentMethod().DeclaringType);

		public HttpResponseMessage GetReport(String ProjectID, String FileType)
		{
			...
			{
				Byte[] bytes = { };
				bytes = generatePDF(ProjectID, FileType, "BudgetSummaryCPP1Report");
		...
		private Byte[] generatePDF(String ProjectID, String FileType, String reportName)
		{
