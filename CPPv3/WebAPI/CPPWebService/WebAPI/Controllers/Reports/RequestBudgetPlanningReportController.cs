...
{
	public class RequestBudgetPlanningReportController : System.Web.Http.ApiController
	{
		readonly log4net.ILog logger = log4net.LogManager.GetLogger(System.Reflection.MethodBase.GetCurrentMethod().DeclaringType);

		public HttpResponseMessage GetReport(String ProjectID,string TrendNumber, String FileType)
		{
			...
			{
				Byte[] bytes = { };
				bytes = generatePDF(ProjectID, TrendNumber, FileType, "BudgetPlanningReport");
		...
		private Byte[] generatePDF(String ProjectID,string TrendNumber, String FileType, String reportName)
		{
