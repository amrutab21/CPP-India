...
{
    public class RequestMaterialAdminReportController : System.Web.Http.ApiController
    {
        readonly log4net.ILog logger = log4net.LogManager.GetLogger(System.Reflection.MethodBase.GetCurrentMethod().DeclaringType);

        public HttpResponseMessage GetReport(String MaterialCategoryID, String FileType)
        {
            ...
            {
                Byte[] bytes = { };
                bytes = generatePDF(MaterialCategoryID, FileType, "MaterialAdminReport");
        ...
        private Byte[] generatePDF(String MaterialCategoryID, String FileType, String reportName)
        {
            ...
            param1.Name = "MaterialCategory";
            param1.Value = MaterialCategoryID;
