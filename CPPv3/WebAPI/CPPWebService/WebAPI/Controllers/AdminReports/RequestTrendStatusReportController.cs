...
{
    public class RequestTrendStatusReportController : ApiController
    {
        readonly log4net.ILog logger = log4net.LogManager.GetLogger(System.Reflection.MethodBase.GetCurrentMethod().DeclaringType);
        public HttpResponseMessage GetReport(String ProgramID, String ProgramElementID, String ProjectID, String Status , String FileType)
        {
            ...
            {
                Byte[] bytes = { };
                bytes = generatePDF(ProgramID, ProgramElementID, ProjectID, Status, FileType, "TrendStatusReport");
        ...
        private Byte[] generatePDF(String ProgramID, String ProgramElementID, String ProjectID, String Status, String FileType, String reportName)
        {
