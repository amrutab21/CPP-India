...
{
    public class RequestEmployeeAdminReportController : System.Web.Http.ApiController
    {
        readonly log4net.ILog logger = log4net.LogManager.GetLogger(System.Reflection.MethodBase.GetCurrentMethod().DeclaringType);

        public HttpResponseMessage GetReport(String OrganizationID, String PositionID, String FileType)
        {
            ...
            {
                Byte[] bytes = { };
                bytes = generatePDF(OrganizationID, PositionID, FileType, "EmployeeAdminReport");
        ...
        private Byte[] generatePDF(String OrganizationID, String PositionID, String FileType, String reportName)
        {
