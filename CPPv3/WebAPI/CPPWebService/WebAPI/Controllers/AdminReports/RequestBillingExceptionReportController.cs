...
{
    public class RequestBillingExceptionReportController : System.Web.Http.ApiController
    {
        ...
        public HttpResponseMessage GetReport(String ProgramID, String ProgramElementID, String ProjectID, String FileType)
        {
            ...
            {
                Byte[] bytes = { };
                bytes = generatePDF(ProgramID, ProgramElementID, ProjectID, FileType, "BillingExceptionReport");
