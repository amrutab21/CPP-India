...
{
    public class RequestProjectElementListAdminReportController : System.Web.Http.ApiController
    {
        readonly log4net.ILog logger = log4net.LogManager.GetLogger(System.Reflection.MethodBase.GetCurrentMethod().DeclaringType);

        public HttpResponseMessage GetReport(String ProgramID, String ProgramElementID, String ProjectID, String FileType)
        {
            ...
            {
                Byte[] bytes = { };
                bytes = generatePDF(ProgramID, ProgramElementID, ProjectID, FileType, "ProjectElementListAdminReport");
        ...
        private Byte[] generatePDF(String ProgramID, String ProgramElementID, String ProjectID, String FileType, String reportName)
        {
