...
{
    public class RequestSubcontractorAdminReportController : System.Web.Http.ApiController
    {
        readonly log4net.ILog logger = log4net.LogManager.GetLogger(System.Reflection.MethodBase.GetCurrentMethod().DeclaringType);

        public HttpResponseMessage GetReport(String SubcontractorTypeID, String FileType)
        {
            ...
            {
                Byte[] bytes = { };
                bytes = generatePDF(SubcontractorTypeID, FileType, "SubcontractorsAdminReport");
        ...
        private Byte[] generatePDF(String SubcontractorTypeID, String FileType, String reportName)
        {
            ...
            param1.Name = "SubcontractorType";
            param1.Value = SubcontractorTypeID;
