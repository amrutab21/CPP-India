...
{
    public class RequestProjectApprovalRequirementAdminReportController : System.Web.Http.ApiController
    {
        ...
        public HttpResponseMessage GetReport(String FileType)
        {
            ...
            {
                Byte[] bytes = { };
                bytes = generatePDF(FileType, "ProjectApprovalRequirementsAdminReport");
