angular.module('cpp.controllers').
    controller('AddMaterialModalCtrl', ['$scope', '$timeout', '$uibModal', '$rootScope', '$http', '$uibModalInstance', 'UniqueIdentityNumber',
        function ($scope, $timeout, $uibModal, $rootScope, $http, $uibModalInstance, UniqueIdentityNumber) {
            ...
            if ($scope.params.VendorList.length > 0) {
                $scope.material.VendorID = $scope.params.VendorList[0].VendorID;
            }
