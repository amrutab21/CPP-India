...
angular.module('xenon.factory', []).
        ...
        return {
            ...
            initToggles: function () {
                ...
                $rootScope.sidebarToggle = function () {
                    ...
                    console.log($rootScope.layoutOptions.sidebar);
    ...
    factory('$layout', function ($rootScope, $cookies) {
    ...
    factory('Role',function($resource){
        return $resource(serviceBasePath+"Request/Role");
       // return $resource("http://localhost:29986/api/Request/Role");
    }).
    factory('fteposition',['$http','$resource',function($http,$resource){
       return $resource(serviceBasePath+"Request/fteposition");
     // return $resource("http://localhost:29986/api/Request/fteposition");
       // var serviceBase = 'http://localhost:29986/';
     /*   var serviceBase = serviceBasePath;
        var ftePositionService = {};
        var _getFtePosition = function(){
          return  $http.get(serviceBase + 'request/ftePosition').then(function(response){
                return response;
                console.log(response);
            })
        }
        ftePositionService.getFtePosition = _getFtePosition;
        return ftePositionService;*/
    }]).
