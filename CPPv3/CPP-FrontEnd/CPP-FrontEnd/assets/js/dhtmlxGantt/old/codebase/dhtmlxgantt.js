...
"undefined" == typeof window.dhx4 && (window.dhx4 = {
    version: "4.1.3", skin: null, skinDetect: function (t) {
        return {10: "dhx_skyblue", 20: "dhx_web", 30: "dhx_terrace"}[this.readFromCss(t + "_skin_detect")] || null
        ...
        var e = t.getBoundingClientRect(), n = document.body, i = document.documentElement, a = window.pageYOffset || i.scrollTop || n.scrollTop, s = window.pageXOffset || i.scrollLeft || n.scrollLeft, r = i.clientTop || n.clientTop || 0, o = i.clientLeft || n.clientLeft || 0, d = e.top + a - r, _ = e.left + s - o;
        return {top: Math.round(d), left: Math.round(_)}
        ...
        } else for (var e = [], n = 0; n < t.length; n++)e[n] = "object" == typeof t[n] && null != t[n] ? this._copyObj(t[n]) : t[n];
        return e
    }, screenDim: function () {
        var t = navigator.userAgent.indexOf("MSIE") >= 0, e = {};
        ...
        if (null == this.transData) {
            this.transData = {transProp: !1, transEv: null};
            var t = {
    ...
    cache: !1, method: "get", parse: function (t) {
        if ("string" != typeof t)return t;
        if (t = t.replace(/^[\s]+/, ""), window.DOMParser && !dhx4.isIE)var e = (new window.DOMParser).parseFromString(t, "text/xml"); else if (window.ActiveXObject !== window.undefined) {
        ...
        var o = window.XMLHttpRequest && !dhx4.isIE ? new XMLHttpRequest : new ActiveXObject("Microsoft.XMLHTTP"), d = null != navigator.userAgent.match(/AppleWebKit/) && null != navigator.userAgent.match(/Qt/) && null != navigator.userAgent.match(/Safari/);
        ...
        if (1 == i && (o.onreadystatechange = function () {
                if (4 == o.readyState || 1 == d && 3 == o.readyState) {
                    ...
                    window.setTimeout(function () {
                        "function" == typeof a && a.apply(window, [{xmlDoc: o}]), null != s && ("undefined" != typeof s.postData ? dhx4.ajax.postLong(s.url, s.postData, a) : dhx4.ajax.getLong(s.url, a)), a = null, o = null
                    }, 1)
                }
            }), "GET" == t && 1 != this.cache && (e += (e.indexOf("?") >= 0 ? "&" : "?") + "dhxr" + (new Date).getTime() + "=1"), o.open(t, e, i), r)for (var _ in r)o.setRequestHeader(_, r[_]);
        else"POST" == t.toUpperCase() || "PUT" == t || "DELETE" == t ? o.setRequestHeader("Content-Type", "application/x-www-form-urlencoded") : "GET" == t && (n = null);
        return o.setRequestHeader("X-Requested-With", "XMLHttpRequest"), o.send(n), i ? void 0 : {xmlDoc: o}
    }
}), "undefined" == typeof window.dhx4._eventable && (window.dhx4._eventable = function (t, e) {
    return "clear" == e ? (t.detachAllEvents(), t.dhxevs = null, t.attachEvent = null, t.detachEvent = null, t.checkEvent = null, t.callEvent = null, t.detachAllEvents = null, void(t = null)) : (t.dhxevs = {data: {}},
    ...
    _isIE = !1, _isOpera = !1, _isKHTML = !1, _isMacOS = !1, _isChrome = !1, _FFrv = !1, _KHTMLrv = !1, _OperaRv = !1, -1 != navigator.userAgent.indexOf("Macintosh") && (_isMacOS = !0), navigator.userAgent.toLowerCase().indexOf("chrome") > -1 && (_isChrome = !0), -1 != navigator.userAgent.indexOf("Safari") || -1 != navigator.userAgent.indexOf("Konqueror") ? (_KHTMLrv = parseFloat(navigator.userAgent.substr(navigator.userAgent.indexOf("Safari") + 7, 5)), _KHTMLrv > 525 ? (_isFF = !0, _FFrv = 1.9) : _isKHTML = !0) : -1 != navigator.userAgent.indexOf("Opera") ? (_isOpera = !0,
    _OperaRv = parseFloat(navigator.userAgent.substr(navigator.userAgent.indexOf("Opera") + 6, 3))) : -1 != navigator.appName.indexOf("Microsoft") ? (_isIE = !0, (-1 != navigator.appVersion.indexOf("MSIE 8.0") || -1 != navigator.appVersion.indexOf("MSIE 9.0") || -1 != navigator.appVersion.indexOf("MSIE 10.0") || document.documentMode > 7) && "BackCompat" != document.compatMode && (_isIE = 8)) : "Netscape" == navigator.appName && -1 != navigator.userAgent.indexOf("Trident") ? _isIE = 8 : (_isFF = !0, _FFrv = parseFloat(navigator.userAgent.split("rv:")[1])),
"undefined" == typeof window.dhtmlxEvent, null == dhtmlxEvent.touchDelay && (dhtmlxEvent.touchDelay = 2e3), "undefined" == typeof dhtmlxEvent.initTouch && (dhtmlxEvent.initTouch = function () {
    function t() {
        if (n) {
    ...
    setTransactionMode: function (t, e) {
        ...
        if (t) {
            ...
            var n = this, i = function (i) {
                var a = [];
                if (e)a.push(e); else if (t)for (var s in t)a.push(s);
            ...
            if ("GET" == this._tMode)dhx4.ajax.get(a + (-1 != a.indexOf("?") ? "&" : "?") + this.serialize(t, e), i); else if ("POST" == this._tMode)dhx4.ajax.post(a, this.serialize(t, e), i); else if ("REST" == this._tMode) {
                var s = this.getState(e), r = a.replace(/(\&|\?)editing\=true/, ""), o = "", d = "post";
                if ("inserted" == s ? o = this.serialize(t, e) : "deleted" == s ? (d = "DELETE", r = r + ("/" == r.slice(-1) ? "" : "/") + e) : (d = "PUT", o = this.serialize(t, e), r = r + ("/" == r.slice(-1) ? "" : "/") + e), this._payload)for (var _ in this._payload)r = r + dhtmlx.url(r) + this.escape(_) + "=" + this.escape(this._payload[_]);

                dhx4.ajax.query({url: r, method: d, headers: this._headers, data: o, callback: i})
            }
            this._waitMode++
        }
        ...
        for (var t = {}, e = !1, n = 0; n < this.updatedRows.length; n++) {
            ...
            this._in_progress[i] || this.is_invalid(i) || this.callEvent("onBeforeUpdate", [i, this.getState(i), this._getRowData(i)]) && (t[i] = this._getRowData(i, i + this.post_delim), e = !0, this._in_progress[i] = (new Date).valueOf())
        }
        return e ? t : null
        ...
        if (window.JSON)try {
            var i = JSON.parse(e.xmlDoc.responseText), a = i.action || this.getState(n) || "updated", s = i.sid || n[0], r = i.tid || n[0];
        ...
        for (var l = 0; l < _.length; l++) {
            var h = _[l], a = h.getAttribute("type"), s = h.getAttribute("sid"), r = h.getAttribute("tid");
    ...
    setOnBeforeUpdateHandler: function (t) {
        ...
        var t = this, e = this.obj.getUserData(0, "version"), n = this.serverProcessor + dhtmlx.url(this.serverProcessor) + ["dhx_user=" + this._user, "dhx_version=" + e].join("&");
...
}, window.Gantt = {_seed: 0}, Gantt.plugin = function (t) {
    ...
    var gantt = {version: "3.2.0"};
    gantt = {version: "3.2.0"}, dhtmlxEventable = function (obj) {
        ...
        if (t.getBoundingClientRect) {
            var i = t.getBoundingClientRect(), a = document.body, s = document.documentElement, r = window.pageYOffset || s.scrollTop || a.scrollTop, o = window.pageXOffset || s.scrollLeft || a.scrollLeft, d = s.clientTop || a.clientTop || 0, _ = s.clientLeft || a.clientLeft || 0;
        ...
        this._click.gantt_close = dhtmlx.bind(function (t, e) {
            ...
            if (this.callEvent("onGridHeaderClick", [i, t]))if ("add" == i)this._click.gantt_add(t, this.config.root_id);
                ...
                a = "desc" == a ? "asc" : "desc", this._sort = {name: i, direction: a}, this.sort(i, "desc" == a)
            }
        ...
        for (var t = this.getGridColumns(), e = [], n = 0, i = this.locale.labels, a = this.config.scale_height - 2, s = 0; s < t.length; s++) {
            ...
            var d = this._sort && o.name == this._sort.name ? "<div class='gantt_sort gantt_" + this._sort.direction + "'></div>" : "", _ = ["gantt_grid_head_cell", "gantt_grid_head_" + o.name, r ? "gantt_last_cell" : "", this.templates.grid_header_class(o.name, o)].join(" "), l = "width:" + (o.width - (r ? 1 : 0)) + "px;", h = o.label || i["column_" + o.name];
        ...
        for (var e = this.getGridColumns(), n = [], i = 0; i < e.length; i++) {
            ...
            var d = "gantt_cell" + (r ? " gantt_last_cell" : ""), _ = "";
            if (o.tree) {
        ...
        if (t != n) {
            ...
            var a = this.getTask(t), s = this.getParent(a.id), r = (this.getChildren(this.getParent(a.id)), this.getChildren(n));
        ...
        dhtmlx.defined(this.config.dnd_sensitivity) && (t.config.sensitivity = this.config.dnd_sensitivity), t.attachEvent("onBeforeDragStart", dhtmlx.bind(function (e, n) {
            ...
            if (this.isTaskExists(o) || (o = t.lastTaskOfLevel(d.$level),
                ...
                var _ = gantt._get_position(r), l = this.getTask(o);
                if (_.y + r.offsetHeight / 2 < s) {
                    var h = this.getGlobalTaskIndex(l.id), c = this._pull[this._order[h + 1]];
                    if (c) {
                        if (c.id == d.id)return;
                        l = c
                    } else if (c = this._pull[this._order[h]], c.$level == d.$level && c.id != d.id)return void this.moveTask(d.id, -1, this.getParent(c.id))
                }
                for (var h = this.getGlobalTaskIndex(l.id), g = this._pull[this._order[h - 1]], u = 1; (!g || g.id == l.id) && h - u >= 0;)g = this._pull[this._order[h - u]], u++;
                if (d.id == l.id)return;
            ...
            this.callEvent("onBeforeRowDragEnd", [t.config.id, t.config.index, t.config.parent]) === !1 ? (this.moveTask(t.config.id, t.config.index, t.config.parent), e.$drop_target = null) : this.callEvent("onRowDragEnd", [t.config.id, e.$drop_target]),
        ...
        for (var t = this.getGridColumns(), e = 0, n = this.config.scale_height, i = (this._get_position(this.$grid_scale), 0); i < t.length; i++) {
            ...
            if (e += a.width, a.resize) {
                ...
                s.className = "gantt_grid_column_resize_wrap",
                    s.style.top = "0px", s.style.height = n + "px", s.innerHTML = "<div class='gantt_grid_column_resize'></div>", s.setAttribute(this.config.grid_resizer_column_attribute, i), this.$grid_scale.appendChild(s), s.style.left = Math.max(0, e - 1 - s.offsetWidth / 2) + "px"
            }
        }
        if (this.config.grid_resize) {
            var r = document.createElement("div");
            r.className = "gantt_grid_resize_wrap", r.style.top = "0px", r.style.height = this.$grid.offsetHeight + "px", r.innerHTML = "<div class='gantt_grid_resize'></div>", r.setAttribute(this.config.grid_resizer_attribute, !0),
                this.$grid_scale.appendChild(r), r.style.left = Math.max(0, this.config.grid_width - 1 - r.offsetWidth / 2) + "px"
        }
        ...
        dhtmlx.defined(this.config.dnd_sensitivity) && (t.config.sensitivity = this.config.dnd_sensitivity), t.attachEvent("onBeforeDragStart", dhtmlx.bind(function (t, e) {
            ...
            a -= i.x - 1;
            for (var _ = 0; _ < e.drag_index; _++)s += n[_].width, o += n[_].width;
            ...
            if (gantt.callEvent("onColumnResizeEnd", [i, a, r]) !== !1 && a.width != r) {
                if (a.width = r, this.config.keep_grid_width)for (var s = i + 1, o = e.length; o > s; s++)e[s].width = "add" == e[s].name ? 1 * e[s].width || 44 : null; else {
        ...
        dhtmlx.defined(this.config.dnd_sensitivity) && (e.config.sensitivity = this.config.dnd_sensitivity), e.attachEvent("onBeforeDragStart", dhtmlx.bind(function (t, e) {
            ...
            for (var r = t.length, o = i - n, a = 0; r > a; a++) {
                var d = Math.floor(o * (t[a].width / n));
                n -= t[a].width, o -= d, t[a].width += d
            }
            gantt.callEvent("onGridResizeEnd", [this.config.grid_width, i]) !== !1 && (this.config.grid_width = i,
                this.render())
        }, this))
        ...
        if (gantt.config.branch_loading && gantt._load_url) {
            ...
            if (!e) {
                ...
                var i = n.indexOf("?") >= 0 ? "&" : "?", a = 0;

                this._cached_scroll_pos && this._cached_scroll_pos.y && (a = Math.max(this._cached_scroll_pos.y, 0)), gantt.load(n + i + "parent_id=" + encodeURIComponent(t), this._load_type, function () {
        ...
        getSum: function (t, e, n) {
            ...
            for (var a = this.splitSize(i, t.length), s = n, r = [], o = t.length - 1; o >= 0; o--) {
                var d = o == t.length - 1, _ = this.initScaleConfig(t[o]);
            ...
            for (var s = e.trace_x, r = t.trace_x, o = n || 0, d = i || r.length - 1, _ = 0, l = 1; l < s.length; l++)for (var h = o; d >= h; h++)+r[h] != +s[l] || (a && a.apply(this, [_, l, o, h]), o = h, _ = l)
            ...
            var s = new Date(i);
            for (+s >= +a && (a = gantt.date.add(s, e, t)); +a > +s;)n.call(this, new Date(s)), s = gantt.date.add(s, e, t), s = gantt.date[t + "_start"](s)
        ...
        drag: null, _events: {before_start: {}, before_finish: {}, after_finish: {}}, _handlers: {}, init: function () {
            ...
            this.set_actions();
            var e = {
                before_start: "onBeforeTaskDrag", before_finish: "onBeforeTaskChanged",
            ...
            var i = this._drag_task_coords(t, n), a = gantt.dateFromPos(i.start + e), s = gantt.dateFromPos(i.end + e);
            ...
            var a = gantt._tasks.unit, s = gantt._tasks.step;
            ...
            if (e.mode && e.id) {
                ...
                if (gantt.config.work_time && gantt.config.correct_work_time && this._fix_working_times(n, e),
                        this._fix_dnd_scale_time(n, e), gantt._init_task_timing(n), this._fireEvent("before_finish", e.mode, [e.id, e.mode, dhtmlx.copy(e.obj), t])) {
                    var i = e.id;
        ...
        var _ = i[i.length - 1].direction, l = gantt._render_link_arrow(e[e.length - 1], _);
        ...
        current_pos: null, dirs: {left: "left", right: "right", up: "up", down: "down"}, path: [], clear: function () {
            ...
            switch (t.direction) {
                ...
                case this.dirs.up:
                    e = {
                        top: i - t.size,
                        lineHeight: t.size + n, height: t.size + n, left: t.x - n / 2, width: n
                    };
                    break;
                case this.dirs.down:
        ...
        path: [], clear: function () {
            ...
            if (t.type == gantt.config.links.start_to_start)this.point_to(s.left, r),
                o ? (this.point_to(s.down, i), this.point_to(s.right, a)) : (this.point_to(s.right, a), this.point_to(s.down, i)), this.point_to(s.right, r); else if (t.type == gantt.config.links.finish_to_start)if (o = e.e_x > e.x + 2 * r, this.point_to(s.right, r), o)a -= r, this.point_to(s.down, i), this.point_to(s.right, a); else {
                a -= 2 * r;
                var d = i > 0 ? 1 : -1;
            ...
            } else if (t.type == gantt.config.links.finish_to_finish)this.point_to(s.right, r),
                o ? (this.point_to(s.right, a), this.point_to(s.down, i)) : (this.point_to(s.down, i), this.point_to(s.right, a)), this.point_to(s.left, r); else if (t.type == gantt.config.links.start_to_finish)if (o = e.e_x > e.x - 2 * r, this.point_to(s.left, r), o) {
                a += 2 * r;
                var d = i > 0 ? 1 : -1;
        ...
        function i() {
            return {
                from: gantt._link_source_task, to: gantt._link_target_task, from_start: gantt._link_source_task_start,
        ...
        function s(t, e, n, a) {
            var s = d(), _ = i(), l = ["gantt_link_direction"];
            ...
            if (h = Math.max(0, h - 3)) {
                ...
                var u = Math.sin(g), f = Math.cos(g), p = Math.round(e), v = Math.round(t), m = ["-webkit-transform: rotate(" + g + "rad)", "-moz-transform: rotate(" + g + "rad)", "-ms-transform: rotate(" + g + "rad)", "-o-transform: rotate(" + g + "rad)", "transform: rotate(" + g + "rad)", "width:" + Math.round(h) + "px"];
                ...
                m.push("top:" + p + "px"),
                    m.push("left:" + v + "px"), s.style.cssText = m.join(";")
            }
        }
        ...
        var l = new dhtmlxDnD(this.$task_bars, {
            sensitivity: 0,
            updates_per_second: 60
        }), h = "task_left", c = "task_right", g = "gantt_link_point", u = "gantt_link_control";
        l.attachEvent("onBeforeDragStart", dhtmlx.bind(function (e, n) {
            ...
            if (gantt._locate_css(i, g)) {
                ...
                return gantt._get_safe_type(r.type) == gantt.config.types.milestone && (o = (gantt._get_visible_milestone_width() - gantt._get_milestone_width()) / 2),
                    this._dir_start = t(r, !!gantt._link_source_task_start, o), !0
            }
            return !1
        }, this)), l.attachEvent("onAfterDragStart", dhtmlx.bind(function () {
            e(l.config.marker)
        }, this)), l.attachEvent("onDragMove", dhtmlx.bind(function (i, a) {
            var r = l.config, o = l.getPosition(a);
            n(r.marker, o);
            var d = gantt._is_link_drop_area(a), _ = gantt._link_target_task, h = gantt._link_landing, g = gantt._link_target_task_start, f = gantt.locate(a), p = !0;
            if (d && (p = !gantt._locate_css(a, c), d = !!f), gantt._link_target_task = f, gantt._link_landing = d, gantt._link_target_task_start = p,
                    d) {
                var v = gantt.getTask(f), m = gantt._locate_css(a, u), k = 0;
            ...
            var x = !(h == d && _ == f && g == p);
            return x && (_ && gantt.refreshTask(_, !1), f && gantt.refreshTask(f, !1)), x && e(r.marker), s(this._dir_start.x, this._dir_start.y, this._dir_end.x, this._dir_end.y), !0
        }, this)), l.attachEvent("onDragEnd", dhtmlx.bind(function () {
            var t = i();
            if (t.from && t.to && t.from != t.to) {
                var e = gantt._get_link_type(t.from_start, t.to_start), n = {
                    source: t.from, target: t.to, type: e
                };
        ...
        this._tasks = {
            ...
            var e = gantt._get_mouse_pos(t), n = gantt.dateFromPos(e.x), i = Math.floor(gantt._day_index_by_date(n)), a = gantt._tasks.trace_x[i];
        ...
        this._taskRenderer = this._task_layers.getRenderer(n), this.addTaskLayer({
            ...
            container: this.$grid_data, filter: gantt._create_filter(["_filter_task", "_is_grid_visible"])
        }), this.addTaskLayer({
        ...
        return this.config.start_date && this.config.end_date && (n = this.config.start_date.valueOf(),
            i = this.config.end_date.valueOf(), +e.start_date > i || +e.end_date < +n) ? !1 : !0
        ...
        this._min_date = e.start_date, this._max_date = e.end_date, this._max_date && this._max_date || (this._min_date = new Date,
            this._max_date = new Date(this._min_date)), this._min_date = this.date[t + "_start"](this._min_date), this._min_date = this.calculateEndDate(this.date[t + "_start"](this._min_date), -1, t), this._max_date = this.date[t + "_start"](this._max_date), this._max_date = this.calculateEndDate(this._max_date, 2, t)
    }, gantt._prepare_scale_html = function (t) {
        var e = [], n = null, i = null, a = null;
        (t.template || t.date) && (i = t.template || this.date.date_to_str(t.date)), a = t.css || function () {
        }, !t.css && this.config.inherit_scale_class && (a = gantt.templates.scale_cell_class);

        for (var s = 0; s < t.count; s++) {
            n = new Date(t.trace_x[s]);
            var r = i.call(this, n), o = t.width[s], d = "", _ = "", l = "";
            if (o) {
                d = "width:" + o + "px;", l = "gantt_scale_cell" + (s == t.count - 1 ? " gantt_last_cell" : ""), _ = a.call(this, n), _ && (l += " " + _);
        ...
        this._init_tasks_range(), this._scroll_resize(),
            this._set_sizes();
        var t = "", e = 0, n = 0, i = 0;
        ...
        if (gantt.config.show_task_cells)for (var a = 0; n > a; a++) {
            ...
            if (s > 0) {
                ...
                o.style.width = s + "px",
                    r = "gantt_task_cell" + (a == n - 1 ? " gantt_last_cell" : ""), _ = this.templates.task_cell_class(t, e.trace_x[a]), _ && (r += " " + _), o.className = r, i.appendChild(o)
            }
        }
        var d = t.$index % 2 !== 0, _ = gantt.templates.task_row_class(t.start_date, t.end_date, t), l = "gantt_task_row" + (d ? " odd" : "") + (_ ? " " + _ : "");
        return this.getState().selected_task == t.id && (l += " gantt_selected"), i.className = l, i.style.height = gantt.config.row_height + "px", i.setAttribute(this.config.task_attribute, t.id), i
        ...
        this._get_safe_type(s.type) == this.config.types.milestone && i.push("gantt_milestone"), this._get_safe_type(s.type) == this.config.types.project && i.push("gantt_project"), this._is_flex_task(s) && i.push("gantt_dependent_task"),
        this.config.select_task && n == a.selected_task && i.push("gantt_selected"), n == a.drag_id && (i.push("gantt_drag_" + a.drag_mode), a.touch_drag && i.push("gantt_touch_" + a.drag_mode));
        ...
        if (r.link_source_id == n && i.push("gantt_link_source"), r.link_target_id == n && i.push("gantt_link_target"), this.config.highlight_critical_path && this.isCriticalTask && this.isCriticalTask(s) && i.push("gantt_critical_task"), r.link_landing_area && r.link_target_id && r.link_source_id && r.link_target_id != r.link_source_id) {
            var o = r.link_source_id, d = r.link_source_start, _ = r.link_target_start, l = gantt.isLinkAllowed(o, n, d, _), h = "";
        ...
        var e = this.config.type_renderers, n = e[this._get_safe_type(t.type)], i = this._task_default_render;
        ...
        var e = document.createElement("div");
        return this._get_safe_type(t.type) != this.config.types.milestone && (e.innerHTML = this.templates.task_text(t.start_date, t.end_date, t)),
            e.className = "gantt_task_content", e
        ...
        if (s = Math.min(n, s), t.progressColor && (a.style.backgroundColor = t.progressColor, a.style.opacity = 1), a.style.width = s + "px", a.className = "gantt_task_progress", a.innerHTML = this.templates.progress_text(t.start_date, t.end_date, t), e.appendChild(a), this.config.drag_progress && !gantt._is_readonly(t)) {
            var r = document.createElement("div");
            r.style.left = s + "px",
                r.className = "gantt_task_progress_drag", a.appendChild(r), e.appendChild(r)
        }
        ...
        var n = this._findBinary(this._tasks.left, t), i = this._tasks.left[n], a = e.width[n] || e.col_width, s = 0;
        a && (s = (t - i) / a);
        var r = 0;
        ...
        var n = Math.floor(e), i = e % 1, a = gantt._tasks.left[Math.min(n, gantt._tasks.width.length - 1)];
        return n == gantt._tasks.width.length && (a += gantt._tasks.width[gantt._tasks.width.length - 1]), i && (a += n < gantt._tasks.width.length ? gantt._tasks.width[n] * (i % 1) : 1), a
        ...
        for (var n, i, a, s = 0, r = t.length - 1; r >= s;)if (n = Math.floor((s + r) / 2), i = +t[n], a = +t[n - 1], e > i)s = n + 1; else {
            if (!(i > e))return n;
        ...
        var n = _isIE ? document.documentElement : document.body, e = {
            x: t.clientX + n.scrollLeft - n.clientLeft, y: t.clientY + n.scrollTop - n.clientTop
        ...
        return this._task_area_pulls || (this._task_area_pulls = {}), this._task_area_renderers || (this._task_area_renderers = {}), this._task_area_renderers[t] ? this._task_area_renderers[t] : (e || dhtmlx.assert(!1, "Invalid renderer call"), n && n.setAttribute(this.config.layer_attribute, !0),
        ...
        if (n.getContext) {
            ...
            o.beginPath(), o.moveTo(0, i), o.lineTo(a, i), o.lineWidth = 1, o.strokeStyle = getComputedStyle(s).getPropertyValue("border-bottom-color") || "#ebebeb",
                o.stroke(), o.beginPath(), o.moveTo(a, i), o.lineTo(a, 0), o.lineWidth = 1, o.strokeStyle = getComputedStyle(r).getPropertyValue("border-right-color") || "#ebebeb", o.stroke(), t.fill_img = n.toDataURL(), e.style.height = i * gantt._order.length + "px", e.style.backgroundImage = "url(" + t.fill_img + ")", e.removeChild(s)
        }
        ...
        prepareConfig: function (t) {
            ...
            return {
                tempCollection: [], renderers: {}, container: t, getRenderers: function () {
                    ...
                    if (t && this.tempCollection.push(t), this.container())for (var n = this.container(), i = this.tempCollection, a = 0; a < i.length; a++) {
                        var t = i[a], s = t.container, r = t.id, o = t.topmost;
    ...
    gantt.removeLinkLayer = function (t) {
        ...
        _xmlNodeToJSON: function (t, e) {
            ...
            for (var e = {}, n = dhx4.ajax.xpath("//coll_options", t), i = 0; i < n.length; i++)for (var a = n[i].getAttribute("for"), s = e[a] = [], r = dhx4.ajax.xpath(".//item", n[i]), o = 0; o < r.length; o++) {
        ...
        parse: function (t, e) {
            ...
            for (var n = {collections: {links: []}}, i = n.data = [], a = dhx4.ajax.xpath("//task", e), s = 0; s < a.length; s++) {
        ...
        _working_units_cache: {
            _cache: {}, get: function (t, e) {
                if (!t || !e)return -1;
                var n = this._cache, i = e.getTime(), a = -1;
                return n && n[t] && void 0 !== n[t][i] && (a = n[t][i]), a
            }, put: function (t, e, n) {
                if (!t || !e)return !1;
                var i = this._cache, a = e.getTime();
        ...
        add_worktime: function (t, e, n, i) {
            if (!n)return !1;
            var a = new Date(t), s = 0, i = i || 1, e = 1 * e;
        ...
        get_closest_worktime: function (t) {
            ...
            var e = t.unit, n = gantt.date[e + "_start"](t.date), i = new Date(n), a = new Date(n), s = !0, r = 3e3, o = 0, d = "any" == t.dir || !t.dir, _ = 1;
            for ("past" == t.dir && (_ = -1); !this.is_working_unit(n, e);)if (d && (n = s ? i : a, _ = -1 * _), n = gantt.date.add(n, _, e), n = gantt.date[e + "_start"](n), d && (s ? i = n : a = n), s = !s, o++, o > r)return dhtmlx.assert(!1, "Invalid working time check"), !1;
        ...
        for (var i = this.getChildren(n), a = !1, s = 0, r = i.length; r > s; s++)if (i[s] == t.id) {
            a = !0;
            break
        }
        ...
        return dhtmlx.defined(e) || (e = this.getParent(t) || 0), this.isTaskExists(e) || (e = 0), this.setParent(t, e), t = this._init_task(t), this.callEvent("onBeforeTaskAdd", [t.id, t]) === !1 ? !1 : (this._pull[t.id] = t, this._add_branch(t), this.refreshData(), this._adjust_scales(),
            this.callEvent("onAfterTaskAdd", [t.id, t]), t.id)
    ...
    gantt.createTask = function (t, e) {
        ...
        var e = this.getTask(t);
        if (!e)return [];
        for (var n = [], i = this.getChildren(e.id), a = 0; a < i.length; a++)n.push(i[a]),
            n = n.concat(this._getTaskTree(i[a]));
        return n
    },gantt._deleteRelatedLinks = function (t, e) {
        var n = this._dp && !e, i = "", a = n ? "off" != this._dp.updateMode : !1;
        ...
        var n = this._dp && !e, i = "";
        n && (i = this._dp.updateMode, this._dp.setGanttMode("tasks"),
        ...
        return this._deleteRelatedTasks(t, e),
            this._deleteRelatedLinks(i, e), this._unset_task(t), e || (this.callEvent("onAfterTaskDelete", [t, n]), this.refreshData()), !0
        ...
        var i = this._working_time_helper, a = e >= 0 ? 1 : -1;
        return i.add_worktime(t, Math.abs(e), n || this.config.duration_unit, a * this.config.duration_step)
    },gantt._init_task = function (t) {
        return dhtmlx.defined(t.id) || (t.id = dhtmlx.uid()), t.start_date && (t.start_date = gantt.date.parseDate(t.start_date, "xml_date")), t.end_date && (t.end_date = gantt.date.parseDate(t.end_date, "xml_date")), t.start_date && !t.end_date && t.duration && (t.end_date = this.calculateEndDate(t.start_date, t.duration)),
            gantt._init_task_timing(t), t.start_date && t.end_date && gantt.correctTaskWorkTime(t), t.$source = [], t.$target = [], void 0 === t.parent && this.setParent(t, this.config.root_id), t.$open = dhtmlx.defined(t.open) ? t.open : this.config.open_tree_initially, t.$level = this.calculateTaskLevel(t), t
    },gantt._init_task_timing = function (t) {
        var e = this._get_safe_type(t.type);
        void 0 === t.$rendered_type ? t.$rendered_type = e : t.$rendered_type != e && (delete t.$no_end, delete t.$no_start, t.$rendered_type = e), void 0 !== t.$no_end && void 0 !== t.$no_start || e == this.config.types.milestone || (e == this.config.types.project ? (t.$no_end = t.$no_start = !0,
            this._set_default_task_timing(t)) : (t.$no_end = !(t.end_date || t.duration), t.$no_start = !t.start_date)), e == this.config.types.milestone && (t.end_date = t.start_date), t.start_date && t.end_date && (t.duration = this.calculateDuration(t.start_date, t.end_date)), t.duration = t.duration || 0
        ...
        var e = null, n = null, i = void 0 !== t ? t : gantt.config.root_id;
        ...
        }, i), {start_date: e ? new Date(e) : null, end_date: n ? new Date(n) : null}
    },gantt._assign_project_dates = function (t, e, n) {
        t.$no_start && (t.start_date = e && e != 1 / 0 ? new Date(e) : this._default_task_date(t, this.getParent(t))),
        t.$no_end && (t.end_date = n && n != -(1 / 0) ? new Date(n) : this.calculateEndDate(t.start_date, this.config.duration_step)), (t.$no_start || t.$no_end) && this._init_task_timing(t)
        ...
        for (var e = t.date, n = t.step, i = t.unit, a = gantt.date[i + "_start"](new Date(this._min_date)); +e > +a;)a = gantt.date[i + "_start"](gantt.date.add(a, n, i));
        ...
        t.setTransactionMode("POST", !0), t.serverProcessor += (-1 != t.serverProcessor.indexOf("?") ? "&" : "?") + "editing=true", t._serverProcessor = t.serverProcessor, t.styles = {
            ...
            if ("REST" == this._tMode) {
                var t = this._ganttMode.substr(0, this._ganttMode.length - 1);
                this.serverProcessor = this._serverProcessor + ("/" == this._serverProcessor.slice(-1) ? "" : "/") + t
            } else this.serverProcessor = this._serverProcessor + window.dhtmlx.url(this._serverProcessor) + "gantt_mode=" + this._ganttMode;
        ...
        t.afterUpdate = function () {
            ...
            var i = t._ganttMode, a = n.filePath || (n.xmlDoc ? n.xmlDoc.responseURL : "");
            ...
            var n;
            n = "tasks" == t._ganttMode ? this.isTaskExists(e) ? this.getTask(e) : {id: e} : this.isLinkExists(e) ? this.getLink(e) : {
                id: e
            }, n = dhtmlx.copy(n);
            var i = {};
    ...
    gantt.showLightbox = function (t) {
        ...
        var t = this.getLightboxValues();
        this.callEvent("onLightboxSave", [this._lightbox_id, t, !!t.$new]) && (t.$new ? (delete t.$new, this.addTask(t)) : this.isTaskExists(t.id) && (dhtmlx.mixin(this.getTask(t.id), t, !0), this.updateTask(t.id)),
        ...
        for (var e = this._get_typed_lightbox_config(), n = 0; n < e.length; n++) {
            ...
            if (a) {
                var s = a.get_value.call(this, i, t, e[n]), r = gantt._resolve_default_mapping(e[n]);
        ...
        for (var a = this._get_typed_lightbox_config(this.getLightboxType()), s = 0; s < a.length; s++) {
            ...
            if (this.form_blocks[r.type]) {
                var o = document.getElementById(r.id).nextSibling, d = this.form_blocks[r.type], _ = gantt._resolve_default_mapping(a[s]), l = dhtmlx.defined(n[_]) ? n[_] : r.default_value;
        ...
        var a = document.getElementById(i.id), s = a.nextSibling, r = {
            section: i,
            header: a,
            node: s,
            getValue: function (t) {
        ...
        getTimePicker: function (t, e) {
            ...
            for (var o = "", d = 0; d < n.length; d++) {
                ...
                switch (_) {
                    case"%Y":
                        ...
                        var h, c, g, u;
                        t.year_range && (isNaN(t.year_range) ? t.year_range.push && (g = t.year_range[0], u = t.year_range[1]) : h = t.year_range), h = h || 10, c = c || Math.floor(h / 2),
                            g = g || a.getFullYear() - c, u = u || g + h;
                ...
                if (l) {
                    var k = t.readonly ? "disabled='disabled'" : "", x = e ? " style='display:none'" : "";
            ...
            render: function (t) {
                ...
                "string" == typeof _ && (_ = {start_date: _});
                var l = n[_.start_date] || new Date, h = n[_.end_date] || gantt.calculateEndDate(l, 1);
                ...
                var l = gantt._resolve_default_mapping(n), h = {start_date: new Date(d), end_date: new Date(_)};
            ...
            render: function (t) {
                ...
                var r = i, o = t.getElementsByTagName("select"), d = t.getElementsByTagName("input"), _ = d[1], l = [d[0], d[2]], h = t.getElementsByTagName("span")[0], c = i._time_format_order;
                ...
                }, this), _.onchange = dhtmlx.bind(function () {
                    a()
                }, this);
                var g = gantt._resolve_default_mapping(i);

                "string" == typeof g && (g = {start_date: g});
                var u = n[g.start_date] || new Date, f = n[g.end_date] || gantt.calculateEndDate(u, 1), p = Math.round(n[g.duration]) || gantt.calculateDuration(u, f);
                ...
                if (dhtmlx.defined(i[3])) {
                    var r = n[i[3]], o = parseInt(r.value, 10);
                ...
                var i = gantt.form_blocks.duration._get_start_date(t, n), a = gantt.form_blocks.duration._get_duration(t, n), s = gantt.calculateEndDate(i, a), r = gantt._resolve_default_mapping(n), o = {
        ...
        var e = t, n = {
            render: e.render, focus: e.focus, set_value: function (t, i, a, s) {
        ...
        gantt._cached_functions = {
            cache: {}, mode: !1, critical_path_mode: !1, wrap_methods: function (t, e) {
                ...
                var e = [], n = ["isCriticalTask", "isCriticalLink", "_isProjectEnd", "_getProjectEnd"];
        ...
        1 * t == t && (this.$task.scrollLeft = t, this._save_scroll_state(t, void 0)), 1 * e == e && (this.$task_data.scrollTop = e, this.$grid_data.scrollTop = e,
        ...
        if (this._is_render_active()) {
            ...
            var t = dhtmlx.copy(this._restore_scroll_state()), e = null;
            if (t && (e = gantt.dateFromPos(t.x + this.config.task_scroll_offset)), this._render_grid(), this._render_tasks_scales(), this._scroll_resize(), this._on_resize(), this._render_data(), this.config.preserve_scroll && t) {
                var n = gantt._restore_scroll_state(), i = gantt.dateFromPos(n.x);
        ...
        function t(t) {
            ...
            var i = e ? -20 * t.deltaX : 2 * t.wheelDeltaX, a = e ? -40 * t.deltaY : t.wheelDelta;
        ...
        dhtmlx.mixin(gantt.config, {
            ...
            }, {name: "start_date", align: "center", resize: !0}, {name: "duration", align: "center"}, {
                name: "add",
                width: "44"
            }],
            step: 1,
            ...
            _migrate_buttons: {
                dhx_save_btn: "gantt_save_btn", dhx_cancel_btn: "gantt_cancel_btn",
            ...
            lightbox: {
                ...
                milestone_sections: [{name: "description", height: 70, map_to: "text", type: "textarea", focus: !0}, {
                    name: "type", type: "typeselect",
                    map_to: "type"
        ...
        }), gantt.keys = {edit_save: 13, edit_cancel: 27}, gantt._init_template = function (t, e) {
            ...
            gantt._init_template("date_scale", !0),
                gantt._init_template("date_grid", !0), gantt._init_template("task_date", !0), dhtmlx.mixin(this.templates, {
        ...
        t.fn.dhx_gantt = function (n) {
            if (n = n || {}, "string" != typeof n) {
                ...
                return this.each(function () {
                    if (this && this.getAttribute)if (this.gantt)i.push("object" == typeof this.gantt ? this.gantt : window.gantt); else {
        ...
        i.grid = gantt, gantt.init(n.id, t, e),
            n.firstChild.style.border = "none", i.gridId = n.id, i.gridObj = n;
        var a = "_viewRestore";
        ...
        config: {
            grid_width: 360,
            row_height: 35, scale_height: 35, link_line_width: 2, link_arrow_size: 6, lightbox_additional_height: 75
        ...
        this._gantt_touch_event_ready || (this._gantt_touch_event_ready = 1,
            dhtmlxEvent(gantt.$container, t[0], function (t) {
                if (!n(t) && o) {
                    ...
                    if (a && _) {
                        var h = _.pageX - a.pageX, c = _.pageY - a.pageY;
                        !d && (Math.abs(h) > 5 || Math.abs(c) > 5) && (gantt._touch_scroll_active = d = !0, r = 0, s = gantt.getScrollState()), d && gantt.scrollTo(s.x + h, s.y + c)
                    }
                    return i(t)
                }
            ...
            if (!n(t)) {
                ...
                l = setTimeout(function () {
                    ...
                    t && -1 == _.target.className.indexOf("gantt_link_point") && (gantt._tasks_dnd.on_mouse_down(_), gantt._tasks_dnd._start_dnd(_), gantt._touch_drag = !0, a(t), gantt.refreshTask(t), gantt._touch_feedback()), l = null
    ...
    var i = document.createElement("DIV");
    return i.id = "dhxSchedObj_" + this._genStr(12), i.style.cssText = "width:100%; height:100%;", document.body.appendChild(i), this.attachObject(i.id, !1, !0), n = n || (window.gantt.$container ? Gantt.getGanttInstance() : window.gantt), this.vs[this.av].sched = n, this.vs[this.av].schedId = i.id, n.destructor = function () {
    }, n.init(i.id, t, e), this.vs[this._viewRestore()].sched
});
