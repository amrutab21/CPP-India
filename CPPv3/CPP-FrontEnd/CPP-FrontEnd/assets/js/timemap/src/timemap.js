...
// METHODS
    ...
    TimeMapItem.prototype = {
         ...
         *                              (e.g. for batch operations)
         */
        changeTheme: function(newTheme, suppressLayout) {
            var item = this,
                type = item.getType(),
                event = item.event,
         ...
         */
        getNextPrev: function(backwards, inDataset) {
            var item = this,
