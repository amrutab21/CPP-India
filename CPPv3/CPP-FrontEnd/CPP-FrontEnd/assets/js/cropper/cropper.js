...
(function (factory) {
  ...
  Cropper.prototype = {
    ...
    build: function () {
      ...
      this.$uibModal = $cropper.find(".cropper-modal");
      ...
      this.$uibModal.toggleClass(classHidden, !defaults.modal);
    ...
    dragstart: function (event) {
      ...
      if (regexpDirection.test(direction)) {
        ...
        if (direction === "+") {
          this.cropping = true;
          this.$uibModal.removeClass(classHidden);
        }
      }
    },
    ...
    dragend: function (event) {
      ...
      if (this.direction) {
        ...
        if (this.cropping) {
          this.cropping = false;
          this.$uibModal.toggleClass(classHidden, !this.defaults.modal);
        }
